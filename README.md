...
| Memory | Переменная | Это очень важная переменная. В ней можно хранить любые данные, которые пригодятся вам в следующем такте игры. Но тут можно хранить только объекты с переменными, массив или просто значение переменной. Функции она не поддерживает! |
